...
namespace IntroSE.Kanban.Backend.ServiceLayer
{
    public class Service
    {
        ...
        public BoardController bc = new BoardController();
        public TaskService ts = new TaskService();
        public BoardService bs = new BoardService();
        public ColumnService cs = new ColumnService();
        ...
        {
            return cs.LimitColumn(uc, userEmail, creatorEmail, boardName, columnOrdinal, limit);
        }
        ...
        {
            return cs.GetColumnLimit(uc, userEmail, creatorEmail, boardName, columnOrdinal);
        }
        ...
        {
            return cs.GetColumnName(uc, userEmail, creatorEmail, boardName, columnOrdinal);
        }
        ...
        {
            return ts.AddTask(uc, userEmail, creatorEmail, boardName, title, description, dueDate);
        }
        ...
        {
            return ts.UpdateTaskDueDate(uc, userEmail, creatorEmail, boardName, columnOrdinal, taskId, dueDate);
        }
        ...
        {
            return ts.UpdateTaskTitle(uc, userEmail, creatorEmail, boardName, columnOrdinal, taskId, title);
        }
        ...
        {
            return ts.UpdateTaskDescription(uc, userEmail, creatorEmail, boardName, columnOrdinal, taskId, description);
        }
        ...
        {
            return ts.AdvanceTask(uc, userEmail, creatorEmail, boardName, columnOrdinal, taskId);
        }
        ...
        {
            return cs.GetColumn(uc, userEmail, creatorEmail, boardName, columnOrdinal);
        }
        ...
        {
            return bs.AddBoard(uc, userEmail, boardName);
        }
        ...
        {
            return bs.JoinBoard(uc, userEmail, creatorEmail, boardName);
        }
        ...
        {
            return bs.RemoveBoard(uc, userEmail, creatorEmail, boardName);
        }
        ...
        {
            return us.InProgressTasks(uc, userEmail);
        }
        ...
        {
            return ts.AssignTask(uc, userEmail, creatorEmail, boardName, columnOrdinal, taskId, emailAssignee);
        }
        ...
        {
            return bs.GetBoardNames(uc, userEmail);
        }
